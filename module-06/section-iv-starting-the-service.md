...
We are now ready to start the RESTful service that will act as the data soruce for reporting platform, \(Excel, Power BI, Microstrategy, etc.\) by provide the JSON document\(s\) with the number of orders by product.
